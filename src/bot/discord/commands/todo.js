...
const todoList = [
    { name: 'api separation', value: `I want to put an api between myself (the bot) and the \`${config.valheim.name}\` server. This will allow me to be taken down without affecting players playing. **Currently working on this and some features are broken as a result.**` },
