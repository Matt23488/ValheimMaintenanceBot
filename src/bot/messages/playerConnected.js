...
module.exports =  {
    ...
    execute: function (data) {
        ...
        if (user) {
            if (user.pickOn && nPercentChance(25)) discordBot.getDefaultChannel().send(`<@${user.id}> (_${data}_) has joined ${config.valheim.name} and will soon be needing help... <:joy:831246652173844494>`);
